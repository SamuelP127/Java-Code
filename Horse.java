...
public class Main{
    public static void main(String[] args){
        ...
        while(b.getBalance() > 0){
            ...
            if(again.equals("Yes")){
                ...
                while(!y.equals("Yes") && !y.equals("No")){
                    ...
                    if(y.equals("Yes")) {
                        ...
                        if (winner2.equals(horse)) System.out.println("Congratulations you won: $" + b.multiplier(b.getBet()) + " Your new balance is: " + b.win());
                        else {
            ...
            if(b.getBalance() == 0) System.out.print("You ran out of money :( game over!");
        }
    }
}
